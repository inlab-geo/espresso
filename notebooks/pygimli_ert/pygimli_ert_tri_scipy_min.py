...
ax[0].figure.savefig("figs/tri_scipy_opt_model_true")

# generate data
data, log_data, data_cov_inv = ert_simulate(mesh, scheme, rhomap)
ax = ert.show(data)
ax[0].set_title("Provided data")
ax[0].figure.savefig("figs/tri_scipy_opt_data")
...
ax[0].figure.savefig("figs/tri_scipy_opt_inv_mesh")
...
ax[0].figure.savefig("figs/tri_scipy_opt_model_start")
...
ax[0].figure.savefig("figs/tri_scipy_opt_inferred_model")
...
ax[0].figure.savefig("figs/tri_scipy_opt_inferred_data")
