...
ax[0].figure.savefig("figs/tri_inbuilt_solver_model_true")

# generate data
data, log_data, data_cov_inv = ert_simulate(mesh, scheme, rhomap)
ax = ert.show(data)
ax[0].figure.savefig("figs/tri_inbuilt_solver_data")
...
# fig.savefig("figs/tri_inbuilt_solver_result")
...
ax[0].figure.savefig("figs/tri_inbuilt_solver_inferred_model")
...
ax[0].figure.savefig("figs/tri_inbuilt_solver_inferred_data")
