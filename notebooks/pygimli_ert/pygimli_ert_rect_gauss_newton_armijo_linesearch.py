...
ax[0].figure.savefig("figs/rect_gauss_newton_armijo_linesearch_model_true")

# generate data
data, log_data, data_cov_inv = ert_simulate(mesh, scheme, rhomap)
ax = ert.show(data)
ax[0].set_title("Provided data")
ax[0].figure.savefig("figs/rect_gauss_newton_armijo_linesearch_data")
...
ax[0].figure.savefig("figs/rect_gauss_newton_armijo_linesearch_inv_mesh")
...
ax[0].figure.savefig("figs/rect_gauss_newton_armijo_linesearch_model_start")
...
ax[0].figure.savefig("figs/rect_gauss_newton_armijo_linesearch_inferred_model")
...
ax[0].figure.savefig("figs/rect_gauss_newton_armjio_linesearch_inferred_data")
