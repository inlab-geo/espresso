...
ax[0].figure.savefig("figs/tri_gauss_newton_model_true")

# generate data
data, log_data, data_cov_inv = ert_simulate(mesh, scheme, rhomap)
ax = ert.show(data)
ax[0].set_title("Provided data")
ax[0].figure.savefig("figs/tri_gauss_newton_data")
...
ax[0].figure.savefig("figs/tri_gauss_newton_inv_mesh")
...
ax[0].figure.savefig("figs/tri_gauss_newton_model_start")
...
ax[0].figure.savefig("figs/tri_gauss_newton_inferred_model")
...
ax[0].figure.savefig("figs/tri_gauss_newton_inferred_data")
