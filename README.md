...
- CoFI [documentation](https://cofi.readthedocs.io/en/latest/index.html) (development version)
- CoFI [GitHub repository](https://github.com/inlab-geo/cofi) (development version)
