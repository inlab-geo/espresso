...
auxclass = getattr(importlib.import_module(".gravityforward2.auxfile", package='inversiontestproblems'), "auxclass")
...
class gravityforward2(auxclass):
    ...
    def __init__(self, example_number=0):
        ...
        if self._ieg==0:
            ...
            self.x_nodes, self.y_nodes, self.z_nodes = auxclass.node_maker(x_node_slice, y_node_slice, z_node_slice)
            ...
            anomaly=1000
            m = auxclass.inject_density(m,self.x_nodes, self.y_nodes, self.z_nodes, -5,-1000,0, anomaly)
            m = auxclass.inject_density(m,self.x_nodes, self.y_nodes, self.z_nodes, -15,-1000,-10, anomaly)
            m = auxclass.inject_density(m,self.x_nodes, self.y_nodes, self.z_nodes, -5,-1000,-10, anomaly)
            m = auxclass.inject_density(m,self.x_nodes, self.y_nodes, self.z_nodes, 5,-1000,-10, anomaly)
            self.m = auxclass.inject_density(m,self.x_nodes, self.y_nodes, self.z_nodes, -5,-1000,-20, anomaly)
