"""
This script demonstrates the "bad" practice for a simple parallel example.
...
As you run this file and you will see, the speed decreases when it's in parallel.
"""
