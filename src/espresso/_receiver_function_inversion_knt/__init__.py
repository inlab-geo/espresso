...
For contributors, add any intialisation code for your problem into _receiver_function_inversion_knt.py, 
under the method `__init__()` of the class `ReceiverFunctionInversionKnt`.

Don't touch this file unless you know what you are doing :)
"""

from ._receiver_function_inversion_knt import *

__all__ = ["ReceiverFunctionInversionKnt"]
