...
For contributors, add any intialisation code for your problem into _receiver_function_inversion_shibutani.py, 
...
from ._receiver_function_inversion_shibutani import *
